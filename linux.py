...
def start_message(message):
    #bot.send_message(message.chat.id, 'Привіт я бот тімоха хочеш дізнатися команди нажми на /help')
...
def send_text(message):
    ...
    #if message.text.lower() == 'на якій мові ти написаний':
    #    bot.send_message(message.chat.id, 'на python')
   ...
   #     pass
    ...
    #if message.text.lower() == 'хто розробник':
    #    bot.send_message(message.chat.id, 'Мій розробник тімоха @timproger')
    #if message.text.lower() == 'бувай':
    #    bot.send_message(message.chat.id, 'допобачення люди')
